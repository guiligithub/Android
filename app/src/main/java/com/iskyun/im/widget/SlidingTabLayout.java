...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private final TabOnPageChangeListener pageChangeListener;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        pageChangeListener = new SlidingTabLayout.TabOnPageChangeListener(this);
    ...
    public void setViewPager(ViewPager2 vp) {
        ...
        this.mViewPager = vp;
        this.mViewPager.unregisterOnPageChangeCallback(pageChangeListener);
        this.mViewPager.registerOnPageChangeCallback(pageChangeListener);
    ...
    public void setViewPager(ViewPager2 vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new InnerPagerAdapter(fa, fragments));
    ...
    private View createView() {
        ...
        RelativeLayout tabView = new RelativeLayout(getContext());
        tabView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));
        TextView tab = new TextView(getContext());
        tab.setId(R.id.tab_title);
    ...
    private void addTab(final int position, String title, View tabView) {
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tab_title);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tabTitle != null) {
                tabTitle.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
                //tabTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextSize);
                tabTitle.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
                if (i == mCurrentTab) {
                    tabTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextSize+dp2px(2));
                } else {
                    tabTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextSize);
                }
                if (mTextAllCaps) {
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            TextView tabTitle = (TextView) currentTabView.findViewById(R.id.tab_title);
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            //for mIndicatorWidthEqualTitle
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                TextView nextTabTitle = (TextView) nextTabView.findViewById(R.id.tab_title);
                mTextPaint.setTextSize(mTextSize);
        ...
        if (mIndicatorWidth > 0 || mIndicatorWidth == 0) {//indicatorWidth大于0时,圆角矩形以及三角形
            float indicatorLeft = currentTabView.getLeft() + (currentTabView.getWidth() - mIndicatorWidth) / 2;

            if (this.mCurrentTab < mTabCount - 1) {
                View nextTab = mTabsContainer.getChildAt(this.mCurrentTab + 1);
                indicatorLeft = indicatorLeft + mCurrentPositionOffset * ((currentTabView.getWidth()) * ONE / 2 + (nextTab.getWidth()) * ONE / 2);
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            if (mIndicatorHeight > 0) {
                ...
                mTrianglePath.lineTo(paddingLeft + (mIndicatorRect.left) * ONE / 2 + (mIndicatorRect.right) * ONE / 2, height - mIndicatorHeight);
    ...
    public void setOnTabSelectListener(OnTabSelectListener listener) {
        ...
        if (pageChangeListener != null)
            pageChangeListener.setOnTabSelectListener(this.mListener);
    }
    //setter and getter
    ...
    static class InnerPagerAdapter extends FragmentStateAdapter {
        ...
        public InnerPagerAdapter(@NonNull FragmentActivity fragmentActivity, List<Fragment> fragments) {
    ...
    private static class TabOnPageChangeListener extends ViewPager2.OnPageChangeCallback {

        private final SlidingTabLayout tabLayout;
        private OnTabSelectListener onTabSelectListener;

        public TabOnPageChangeListener(SlidingTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
             ...
             */
            tabLayout.mCurrentTab = position;
            tabLayout.mCurrentPositionOffset = positionOffset;
