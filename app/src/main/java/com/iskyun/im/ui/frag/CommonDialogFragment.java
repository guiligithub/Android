...
import com.iskyun.im.databinding.FragmentDialogBaseBinding;

import java.lang.reflect.Field;

public class CommonDialogFragment extends BaseDialogFragment<FragmentDialogBaseBinding> implements View.OnClickListener {
    ...
    @Override
    public FragmentDialogBaseBinding onCreateViewBinding(LayoutInflater inflater) {
        return FragmentDialogBaseBinding.inflate(inflater);
    }
    ...
    public static class Builder {
        ...
        public CommonDialogFragment build() {
            CommonDialogFragment fragment = getFragment();
