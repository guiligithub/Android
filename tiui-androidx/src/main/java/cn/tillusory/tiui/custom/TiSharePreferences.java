...
public class TiSharePreferences {
    ...
    public void initCacheValue() {
        ...
        TiSDKManager.getInstance().setSkinPreciseBeauty(getPreciseBeautyVal());
        TiSDKManager.getInstance().setSkinTenderness(getTendernessVal());
        TiSDKManager.getInstance().setPreciseTenderness(getPreciseTendernessVal());

        TiSDKManager.getInstance().setSkinSharpness(getSharpnessVal());

        TiSDKManager.getInstance().setForeheadTransforming(getForeheadTransformingVal());
        ...
        TiSDKManager.getInstance().setChinSlimming(getChinSlimmingVal());

        TiSDKManager.getInstance().setCheekboneSlimming(getCheekboneSlimmingVal());

        TiSDKManager.getInstance().setEyeCorners(getEyeCornersVal());
        TiSDKManager.getInstance().setEyeInnerCorners(getEyeInnerCornersVal());
        TiSDKManager.getInstance().setEyeOuterCorners(getEyeOuterCornersVal());
        ...
        TiSDKManager.getInstance().setBrowHeight(getBrowHeightVal());
        TiSDKManager.getInstance().setBrowLength(getBrowLengthVal());
        TiSDKManager.getInstance().setBrowCorner(getBrowCornerVal());
        TiSDKManager.getInstance().setBrowSize(getBrowSizeVal());
