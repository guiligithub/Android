...
public class TiEyeBrowAdapter extends RecyclerView.Adapter<TiMakeupItemViewHolder> {
    ...
    private int selectedPosition = TiSelectedPosition.POSITION_EYEBROW;
    ...
    public TiEyeBrowAdapter(List<TiMakeupConfig.TiMakeup> list, List<TiMakeupText> textList) {
        this.list = list;
    ...
    public void setSelectedPosition(int selectedPosition) {
        ...
        TiSelectedPosition.POSITION_EYEBROW = selectedPosition;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tiMakeup.isDownloaded()) {
                    ...
                    if (!new File(TiSDK.getMakeupPath(holder.itemView.getContext()) +
                        File.separator + tiMakeup.getType() + File.separator + tiMakeup.getName()).exists()) {
