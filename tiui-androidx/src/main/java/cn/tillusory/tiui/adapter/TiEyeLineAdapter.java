 ...
 */
public class TiEyeLineAdapter extends RecyclerView.Adapter<TiMakeupItemViewHolder> {

    private int selectedPosition = TiSelectedPosition.POSITION_EYELINE;
    ...
    public TiEyeLineAdapter(List<TiMakeupConfig.TiMakeup> list, List<TiMakeupText> textList) {
        this.list = list;
    ...
    public void setSelectedPosition(int selectedPosition) {
        ...
        TiSelectedPosition.POSITION_EYELINE = selectedPosition;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tiMakeup.isDownloaded()) {
                    ...
                    //如果已经下载了，则让美妆生效
                    RxBus.get().post(RxBusAction.ACTION_EYELINE, list.get(selectedPosition).getName());
                }
            }
        });
    }
