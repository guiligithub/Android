...
public class TiWatermarkAdapter extends RecyclerView.Adapter<TiStickerViewHolder> {
    ...
    public TiWatermarkAdapter(List<TiWatermarkConfig.TiWatermark> stickerList) {
    ...
    public void onBindViewHolder(@NonNull final TiStickerViewHolder holder, int position) {
        ...
        final TiWatermarkConfig.TiWatermark tiWatermark = watermarkList.get(holder.getAdapterPosition());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tiWatermark.isDownloaded()) {
                    ...
                    TiSelectedPosition.POSITION_WATERMARK = selectedPosition;
