 ...
 */
public class TiEyelashAdapter extends RecyclerView.Adapter<TiMakeupItemViewHolder> {
    ...
    public TiEyelashAdapter(List<TiMakeupConfig.TiMakeup> list, List<TiMakeupText> textList) {
        this.list = list;
    ...
    public void setSelectedPosition(int selectedPosition) {
        ...
        TiSelectedPosition.POSITION_EYELASH = selectedPosition;
...
//                                        }
                    ...
                    //如果已经下载了，则让美妆生效
                    RxBus.get().post(RxBusAction.ACTION_EYELASH, list.get(selectedPosition).getName());
                }
            }
        });
    }
