...
public enum TiFaceTrim {
    ...
    LABEL_SMALL_SHAPING(R.string.small_shaping, TiFaceTrimAdapter.ITEM_LABEL),//微整形标签
    ...
    CHEEKBONE_SLIMMING(R.string.cheekbone_slimming, R.drawable.ic_ti_cheekbone_slimming, R.drawable.ic_ti_cheekbone_slimming_full, TiFaceTrimAdapter.ITEM_COMMON, R.string.category_face),
    ...
    TiFaceTrim(int stringId, int type) {
        this.stringId = stringId;
        this.type = type;
    }
