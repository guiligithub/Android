...
public class RxBusAction {
    ...
    public static final String ACTION_SKIN_PRECISE_BEAUTY = "ACTION_SKIN_PRECISE_BEAUTY";
    ...
    public static final String ACTION_SKIN_PRECISE_TENDERNESS = "ACTION_SKIN_PRECISE_TENDERNESS";
    public static final String ACTION_SKIN_DARK_CIRCLE = "ACTION_SKIN_DARK_CIRCLE";
    public static final String ACTION_SKIN_CROWS_FEET = "CROWS_FEET";
    public static final String ACTION_SKIN_NASOLABIAL_FOLD ="ACTION_SKIN_NASOLABIAL_FOLD";
    public static final String ACTION_SKIN_HIGH_LIGHT = "HIGH_LIGHT";
    ...
    public static final String ACTION_LIP_GLOSS = "ACTION_LIP_GLOSS";//唇彩

    public static final String ACTION_QUICK_BEAUTY = "ACTION_QUICK_BEAUTY";
    public static final String ACTION_QUICK_BEAUTY_SELECTION = "ACTION_QUICK_BEAUTY_SELECTION";
    public static final String ACTION_FACE_SHAPE = "ACTION_FACE_SHAPE";
    public static final String ACTION_FACE_SHAPE_SELECTION = "ACTION_FACE_SHAPE_SELECTION";
    public static final String ACTION_FILTER = "ACTION_FILTER";
    public static final String ACTION_FILTER_SELECTION = "ACTION_FILTER_SELECTION";
    ...
    public static final String ACTION_GREEN_SCREEN = "ACTION_GREEN_SCREEN";
    public static final String ACTION_SHOW_GREEN_SCREEN = "ACTION_SHOW_GREEN_SCREEN";
    public static final String ACTION_GREEN_SCREEN_SIMILARITY = "ACTION_GREEN_SCREEN_SIMILARITY";
    public static final String ACTION_GREEN_SCREEN_SMOOTHNESS = "ACTION_GREEN_SCREEN_SMOOTHNESS";
    public static final String ACTION_GREEN_SCREEN_ALPHA = "ACTION_GREEN_SCREEN_ALPHA";
    public static final String ACTION_RESTORE_GREEN_SCREEN = "ACTION_RESTORE_GREEN_SCREEN";
    public static final String ACTION_ENABLE_GREEN_SCREEN_RESTORE = "ACTION_ENABLE_GREEN_SCREEN_RESTORE";
