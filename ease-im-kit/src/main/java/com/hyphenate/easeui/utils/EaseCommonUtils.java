    ...
    public static String getMessageDigest(EMMessage message, Context context) {
        ...
        switch (message.getType()) {
            ...
            case CUSTOM:
                ...
                if (Objects.equals(EaseConstant.CALL_END_MESSAGE_EVENT, customBody.event())) {
                    String callType = customBody.getParams().get(EaseConstant.CALL_TYPE);
                    if (String.valueOf(0).equals(callType)) {
                        digest = getString(context, R.string.voice_call);
                    } else if (String.valueOf(1).equals(callType)) {
