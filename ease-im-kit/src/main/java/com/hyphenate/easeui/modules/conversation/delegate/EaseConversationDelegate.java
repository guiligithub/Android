            ...
            if(userProvider != null) {
                ...
                if(mineUser != null){
                    if(mineUser.getGender() == 0){
                        defaultAvatar = R.drawable.icon_man_default;
                    }else {
                        defaultAvatar = R.drawable.icon_woman_default;
                    }
                    Glide.with(holder.mContext).load(defaultAvatar).apply(new RequestOptions()
                ...
                if(user != null) {
                    ...
                    if(!TextUtils.isEmpty(user.getAvatar())) {
                        Drawable drawable = ContextCompat.getDrawable(context, defaultAvatar);
