...
public class EaseConversationListLayout extends EaseBaseLayout implements IConversationListLayout, IConversationStyle
    ...
    private void initListener() {
        ...
        listAdapter.setOnItemLongClickListener(new com.hyphenate.easeui.interfaces.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(View view, int position) {
                listAdapter.getItem(position - rvConversationList.getHeadersCount()).setSelected(true);
                if (itemLongListener != null) {
                    return itemLongListener.onItemLongClick(view, position);
                }
                if (showDefaultMenu) {
                    showDefaultMenu(view, position, listAdapter.getItem(position - rvConversationList.getHeadersCount()));
                    return true;
                }
                return false;
            }
    ...
    public void addHeaderView(View headerView) {
        ...
        rvConversationList.addHeaderView(headerView);
    }
...
//    }
    ...
    public EaseConversationInfo getItem(int position) {
        if (position >= listAdapter.getData().size() + rvConversationList.getHeadersCount() ) {
            throw new ArrayIndexOutOfBoundsException(position);
        }
        return listAdapter.getItem(position - rvConversationList.getHeadersCount());
    }
